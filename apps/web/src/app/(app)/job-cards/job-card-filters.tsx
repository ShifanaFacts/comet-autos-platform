  ...
  return (
    <div className="mb-4 flex flex-wrap gap-2">
      ...
      <select
        ...
        className="rounded-md border border-input bg-transparent px-3 py-1.5 text-sm outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
      >
